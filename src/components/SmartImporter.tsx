    ...
    reader.onload = (e) => {
      try {
        ...
        const nameIdx = headers.findIndex(
          (h) => h.includes("nombre") || h.includes("descrip"),
        );
        ...
        {previewData ? (
          <div className="animate-fade-in">
            <h2 style={{ color: "var(--color-primary)", marginBottom: "10px" }}>
              👀 Revisión y Precios Calculados (AUTO)
            </h2>
            <p
              style={{ color: "var(--color-secondary)", marginBottom: "20px" }}
            >
              ERIKA ha limpiado los textos y extraído los costos. Revisa que
              estén correctos antes de importar.
            </p>
          ...
          <div>
            ...
            >
              Sube tu Excel. La Inteligencia Artificial limpiará los textos feos
              y protegerá contra duplicados.
            </p>
            {isProcessing ? (
              <div style={{ padding: "40px 0" }}>
                <p style={{ color: "var(--color-secondary)" }}>{progress}</p>
              </div>
            ) : (
              <div>
                <input
