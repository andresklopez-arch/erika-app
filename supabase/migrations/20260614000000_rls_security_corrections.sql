...
-- 9. CORRECCIÓN EN TABLA CLIENTES (CUSTOMERS)
...
-- 10. CORRECCIÓN EN TABLA INVENTARIO (INVENTORY)
...
-- 11. CORRECCIÓN EN TABLA PROVEEDORES (SUPPLIERS)
...
-- 12. CORRECCIÓN EN TABLA SERVICIOS/AGENDA (SERVICES)
...
-- 13. COLUMNA DE INTERESES EN DEUDAS A PROVEEDORES (SUPPLIER_DEBTS)
